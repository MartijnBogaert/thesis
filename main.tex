...
\renewcommand{\baselinestretch}{1.5}  % stretch horizontal space between everything
...
\include{chapters/7_related_work}
\include{chapters/8_coghent_link_traversal}
\include{chapters/9_tools_query_building}
\include{chapters/10_handling_query_results}
\include{chapters/11_conclusion}
\include{chapters/12_bibliography}

\pagestyle{numberless} 
\pagestyle{empty}
\include{chapters/13_appendices}
