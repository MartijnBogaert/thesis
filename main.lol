\addvspace {10\p@ }
\addvspace {10\p@ }
\contentsline {listing}{\numberline {2.1}{\ignorespaces RDF description depicted using a human-centric RDF syntax\relax }}{7}{listing.caption.10}%
\contentsline {listing}{\numberline {2.2}{\ignorespaces RDF description depicted using the N-Triples syntax\relax }}{7}{listing.caption.11}%
\contentsline {listing}{\numberline {2.3}{\ignorespaces RDF description depicted using the N3 and Turtle syntaxes\relax }}{8}{listing.caption.12}%
\contentsline {listing}{\numberline {2.4}{\ignorespaces RDF description depicted using the RDF/XML syntax\relax }}{9}{listing.caption.13}%
\contentsline {listing}{\numberline {2.5}{\ignorespaces RDF description with nested objects depicted using the JSON-LD syntax\relax }}{10}{listing.caption.14}%
\contentsline {listing}{\numberline {2.6}{\ignorespaces RDF description spread over two documents depicted using the JSON-LD syntax\relax }}{11}{listing.caption.15}%
\contentsline {listing}{\numberline {2.7}{\ignorespaces RDF description as a graph depicted using the JSON-LD syntax\relax }}{12}{listing.caption.16}%
\contentsline {listing}{\numberline {2.8}{\ignorespaces Example of context use in JSON-LD, proposed by \cite {kellogg2020jsonld}\relax }}{12}{listing.caption.17}%
\contentsline {listing}{\numberline {2.9}{\ignorespaces Example of an expanded JSON-LD document, proposed by \cite {kellogg2020jsonld}\relax }}{13}{listing.caption.18}%
\contentsline {listing}{\numberline {2.10}{\ignorespaces Example of SPARQL query created by original CoGhent Query Builder\relax }}{16}{listing.caption.23}%
\addvspace {10\p@ }
\contentsline {listing}{\numberline {3.1}{\ignorespaces SPARQL query fetching ten Human-Made Object's IIIF Manifest URIs, image heights and image file URIs\relax }}{20}{listing.caption.28}%
\contentsline {listing}{\numberline {3.2}{\ignorespaces Custom link traversal engine configuration using Predicates Extract Links Actor\relax }}{24}{listing.caption.34}%
\contentsline {listing}{\numberline {3.3}{\ignorespaces Comunica Predicates Extract Links Actor configuration with predicate regexes set to predicates from query displayed in Code Fragment\nobreakspace {}\ref {lst:sparql_manifest_height_image} and subject checking \textbf {enabled}\relax }}{25}{listing.caption.35}%
\contentsline {listing}{\numberline {3.4}{\ignorespaces (Cleaned up) logs outputted during execution of engine configured by files displayed in Code Fragments\nobreakspace {}\ref {lst:config_predicates_actor} and\nobreakspace {}\ref {lst:actor_config_regexes_subject_true}\relax }}{27}{listing.caption.36}%
\contentsline {listing}{\numberline {3.5}{\ignorespaces Comunica Predicates Extract Links Actor configuration with predicate regexes set to predicates from query displayed in Code Fragment\nobreakspace {}\ref {lst:sparql_manifest_height_image} and subject checking \textbf {disabled}\relax }}{28}{listing.caption.37}%
\contentsline {listing}{\numberline {3.6}{\ignorespaces Custom link traversal engine configuration using Predicates Extract Links Actor and Extract Links Tree Actor\relax }}{30}{listing.caption.39}%
\contentsline {listing}{\numberline {3.7}{\ignorespaces Turtle file representing hypothetical Human-Made Objects (does not follow CoGhent schema)\relax }}{31}{listing.caption.41}%
\contentsline {listing}{\numberline {3.8}{\ignorespaces Turtle file representing \textbf {first} hypothetical IIIF Manifest (does not follow IIIF schema)\relax }}{31}{listing.caption.42}%
\contentsline {listing}{\numberline {3.9}{\ignorespaces Turtle file representing \textbf {second} hypothetical IIIF Manifest (does not follow IIIF schema)\relax }}{31}{listing.caption.43}%
\contentsline {listing}{\numberline {3.10}{\ignorespaces Turtle file representing combination of hypothetical Human-Made Objects and IIIF Manifests\relax }}{32}{listing.caption.44}%
