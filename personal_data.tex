...
\newacronym{TPF}{TFP}{Triple Pattern Fragment}
\newacronym{CMS}{CMS}{Content management system}
\newacronym{CoGent}{CoGent}{Collectie van de Gentenaar}
\newacronym{RDFS}{RDFS}{Resource Description Framework Schema}
\newacronym{OWL}{OWL}{Web Ontology Language}
\newacronym{LDES}{LDES}{Linked Data Event Stream}
\newacronym{OSLO}{OSLO}{Open Standaarden voor Linkende Organisaties}
\newacronym{SGD}{SGD}{Sustainable Development Goals}